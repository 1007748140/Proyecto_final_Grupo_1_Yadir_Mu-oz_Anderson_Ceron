...
import { register } from '../../controllers/people/register';
import { login } from '../../controllers/user/login';
import { getProfile } from '../../controllers/people/getProfile';
import { updateProfile } from '../../controllers/people/updateProfile';
import { deleteProfile } from '../../controllers/user/deleteProfile';
...
router.post('/api/users/register', [
  ...
  body('idAddress').notEmpty().isInt().withMessage('La dirección es requerida'),
], register);
...
router.put('/api/users/profile/:userId', [
  ...
  body('idAddress').optional().isInt().withMessage('La dirección debe ser un número válido'),
], updateProfile);
