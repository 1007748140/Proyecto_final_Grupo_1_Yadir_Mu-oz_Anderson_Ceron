// src/services/people/updateUserProfileService.ts

import bcrypt from 'bcryptjs';
import dotenv from 'dotenv';
import { GetUserProfileSql } from '../../infra/user/getUserProfileByUserIdSql';
import { UpdateUserSql } from '../../infra/user/updateUser';
import { UpdatePeopleSql } from '../../infra/people/updatePeople';
